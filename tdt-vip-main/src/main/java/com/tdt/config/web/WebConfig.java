...
import com.tdt.sys.core.attribute.AttributeSetInteceptor;
import com.tdt.sys.core.constant.Const;
import com.tdt.sys.core.exception.page.GunsErrorView;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        //registry.addInterceptor(new RestApiInteceptor()).addPathPatterns("/tdtApi/**");
    ...
    public JdkRegexpMethodPointcut druidStatPointcut() {
        ...
        String patterns = "com.tdt.modular.*.service.*";
        //可以set多个
