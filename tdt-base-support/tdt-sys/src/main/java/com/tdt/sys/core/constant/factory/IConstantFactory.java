...
import com.tdt.sys.modular.system.entity.Menu;
...
public interface IConstantFactory {
     ...
     * 根据字典名称获取对应的字典
     */
    Map<String,String> getDictsByNames(String name);
     ...
     * 根据字典类型编码获取字典
     */
    List<Dict> queryDictByCode(String locator_type);

    /**
     * 将审核状态码转化为审核状态名
     */
    String getPurchaseStateName(String state);

    List<Long> queryWarehousesByDept(Long dept_id);
}
