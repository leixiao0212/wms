 ...
 */
package com.tdt.sys.core.log.aop;

import com.tdt.base.dict.AbstractDictMap;
...
import com.tdt.sys.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.tdt.base.log.BussinessLog)")
